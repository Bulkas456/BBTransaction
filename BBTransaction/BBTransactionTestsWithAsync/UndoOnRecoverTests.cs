...
namespace BBTransactionTestsWithAsync
{
    ...
    {
        [TestMethod]
        public async Task WhenRunRecoveredTransactionWithCurrentStepWithUndoOnRecoverSetting_ShouldUndoTheStep()
        {
            // Arrange
        ...
        [TestMethod]
        public async Task WhenRecoverTransactionWithStepExecutors_ShouldRunAllStepsProperly()
        {
            // Arrange
            object transactionData = new object();
            List<string> runStepActions = new List<string>();
        ...
        [TestMethod]
        public async Task WhenRecoverTransactionFromFirstStepWithStepExecutors_ShouldRunAllStepsProperly()
        {
            // Arrange
            object transactionData = new object();
            List<string> runStepActions = new List<string>();
