...
{
    [TestClass]
    public class RecoverAndContinueTests
    {
        [TestMethod]
        public async Task WhenRunRecoveredTransactionWithCurrentStepWithoutUndoOnRecoverSetting_ShouldProcessStepsProperly()
        {
            // Arrange
        ...
        [TestMethod]
        public async Task WhenRunRecoveredTransactionWithCurrentStepAsFirstStepWithExecutorWithoutUndoOnRecoverSetting_ShouldProcessStepsProperly()
        {
            // Arrange
            object transactionData = new object();
            List<string> runStepActions = new List<string>();
            ...
            undoActionThreadId.ShouldAllBeEquivalentTo(new int[0]);
