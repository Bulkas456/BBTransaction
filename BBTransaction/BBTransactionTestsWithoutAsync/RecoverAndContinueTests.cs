...
namespace BBTransactionTestsWithoutAsync
{
    ...
    {
        [TestMethod]
        public void WhenRunRecoveredTransactionWithCurrentStepWithoutUndoOnRecoverSetting_ShouldProcessStepsProperly()
        {
            // Arrange
        ...
        [TestMethod]
        public void WhenRunRecoveredTransactionWithCurrentStepAsFirstStepWithExecutorWithoutUndoOnRecoverSetting_ShouldProcessStepsProperly()
        {
            // Arrange
            object transactionData = new object();
            List<string> runStepActions = new List<string>();
